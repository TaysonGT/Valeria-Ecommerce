...
const HeroSection = () => {
  return (
    <section className='min-h-screen flex-col overflow-hidden flex relative'>
        {/* <Navbar/> */}
          <div className="relative grow text-[#1e1e1e] z-2 space-y-8 bg-[url(/landing/hero.jpg)] bg-cover px-20 py-10 xl:px-30 w-full flex flex-col justify-center font-[Comfortaa]">
