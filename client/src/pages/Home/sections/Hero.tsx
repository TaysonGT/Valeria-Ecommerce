...
const HeroSection = () => {
  return (
    <section className='relative text-[#ffffff] md:text-[#1e1e1e] font-[Comfortaa] overflow-hidden h-[calc(100vh-54px)] md:h-[calc(100vh-88px)]'>
      ...
      <div className="w-full h-full z-11 bg-linear-to-br txt-ce from-[#98830e]/80 to-[#383c00]/90 md:bg-none space-y-8 p-10 sm:px-16 py-10 xl:px-30 flex flex-col sm:items-start justify-center absolute top-0 left-0">
        <div className=' leading-snug text-5xl min-[400px]:text-5xl md:text-6xl xl:text-7xl font-light font-[Titan_One]'>
          <h1>Elegance</h1>
          <h1>Redefined</h1>
          <h1>Style</h1>
        </div>
        <p className='leading-relaxed text-lg md:text-xl text-wrap md:w-1/2'>Discover curated fashion and lifestyle products that reflect your unique personality.</p>
