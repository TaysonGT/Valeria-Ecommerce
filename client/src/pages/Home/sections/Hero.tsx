...
const HeroSection = () => {
  return (
    <section className='relative text-[#ffffff] md:text-[#1e1e1e] font-[Comfortaa] overflow-hidden h-[calc(100vh-54px)] md:h-[calc(100vh-88px)]'>
      ...
      <div className="w-full h-full z-11 bg-linear-to-br txt-ce from-[#98830e]/40 to-[#003c38]/40 md:bg-none space-y-8 p-10 sm:px-16 py-10 xl:px-30 flex flex-col sm:items-start justify-center absolute top-0 left-0">
