    ...
    <section className='md:py-20 py-16 bg-[#f8f8f8] flex justify-center font-[Comfortaa]'>
        <div className='md:px-10 max-w-350 sm:px-6 px-2 w-full flex flex-col items-center'>
          <div className='w-full flex sm:justify-between justify-center items-center gap-6'>
            <div className='flex gap-1.5 sm:items-start items-center flex-col'>
              <h1 className='text-4xl font-bold'>Our Best Sellers</h1>
              <p className='text-base sm:text-lg md:text-xl text-[#2c2c2c] max-w-2xl'>Take a look at our top trending products.</p>
            </div>
            <Link to='/shop' className='self-start border hidden sm:inline-flex border-[#071c1f] z-2 bg-[#071c1f] px-3 py-2 text-white hover:bg-transparent hover:text-[#071c1f] before:bg-[#071c1f] gap-1 rtl text-base duration-300 rounded-md items-center group '>
