    ...
    <section className='py-20 bg-[#f8f8f8] flex justify-center'>
        <div className='px-20 w-full flex flex-col items-center'>
            <div className='w-full flex justify-between items-center'>
                ...
                <Link to='/products' className='self-end border border-[#071c1f] z-2 bg-[#071c1f] px-3 py-2 text-white hover:bg-transparent hover:text-[#071c1f] before:bg-[#071c1f] gap-1 rtl text-base inline-flex duration-300 rounded-md items-center group '>
